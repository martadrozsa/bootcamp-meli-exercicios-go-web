...
Dependendo do tema escolhido, gere um JSON que atenda as seguintes chaves conforme o tema.
...
1. Na pasta go-web crie um arquivo theme.json, o nome tem que ser o tema escolhido, ex: products.json.
2. Dentro dele escreva um JSON que permita ter uma matriz de produtos, usuários ou transações com todas as suas variantes.
*/
