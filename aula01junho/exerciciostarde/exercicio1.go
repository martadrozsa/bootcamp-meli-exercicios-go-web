...
É necessário implementar um gerenciamento de resposta genérico para enviar sempre o
mesmo formato nas solicitações. Para conseguir isso, as seguintes etapas devem ser executadas:
...
3. Desenvolva uma função que receba o código como um inteiro, os dados como uma interface e o erro como uma string.
4. A função deve retornar com base no código, se for uma resposta com os dados ou com o erro.
